...
// export function CartPage({ onNext }: CartPageProps) {
//   const location = useLocation();
//   const { items } = location.state as { items: CartItem[] }; // Type the state
...
//         </div>
//         <Button 
//           onClick={() => navigate('/delivery', { state: { items, subtotal } })} // Navigate with state
