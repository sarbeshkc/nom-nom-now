...
const allMenuItems = [
  {
    ...
    price: 320,
    image: "/chopsey.jpg?height=200&width=200",
  ...
  },
  {
    ...
    name: "Veg Chowmein",
    price: 120,
    image: "/veg chowmin.png?height=200&width=200",
    category: "Lunch",
    distance: 1.8,
  },
  {
    ...
    name: "Chicken Sekuwa",
    price: 180,
    image: "/chick sekuwa.jpg?height=200&width=200",
    category: "Special Foods",
    distance: 3.2,
  },
  {
    ...
    name: "Braciole",
    price: 290,
    image: "/braciole.jpg?height=200&width=200",
    category: "Italian",
    distance: 4.1,
  },
  {
    ...
    price: 320,
    image: "/pasta.jpg?height=200&width=200",
    category: "Italian",
    distance: 2.7,
  },
  {
    ...
    name: "Fish Curry",
    price: 310,
    image: "/fish curry.jpg?height=200&width=200",
    category: "Lunch",
    distance: 1.5,
  },
  {
    ...
    price: 350,
    image: "/chick nugget.jpg?height=200&width=200",
    category: "Lunch",
    distance: 2.0,
  },
  {
    ...
    name: "Buff Tacos",
    price: 320,
    image: "/Buffalo-Taco-Recipe.jpg?height=200&width=200",
    category: "Mexican",
    distance: 3.5,
  },
  {
    ...
    name: "French Fries",
    price: 190,
    image: "/french fries.webp?height=200&width=200",
    category: "Lunch",
    distance: 1.2,
  },
  {
    ...
    price: 420,
    image: "/chicken lollipop.webp?height=200&width=200",
    category: "Special Foods",
    distance: 2.8,
  },
  {
    ...
    price: 375,
    image: "/mexican quesadilla.webp?height=200&width=200",
    category: "Mexican",
    distance: 3.9,
  },
  {
    ...
    price: 180,
    image: "/yomari.png?height=200&width=200",
    category: "Special Foods",
    distance: 4.5,
  },
  {
    ...
    name: "Butter Chicken",
    price: 450,
    image: "/butter chicken.jpg?height=200&width=200",
    category: "Lunch",
    distance: 2.3,
  },
  {
    ...
    price: 550,
    image: "/PIZZA-MARGHERITA.jpg?height=200&width=200",
    category: "Italian",
    distance: 3.0,
  },
  {
    ...
    price: 380,
    image: "/chick biryani.jpg?height=200&width=200",
    category: "Lunch",
    distance: 2.6,
  },
  {
    ...
    name: "Grilled Fish",
    price: 520,
    image: "/grilled fish.webp?height=200&width=200",
    category: "Lunch",
    distance: 3.7,
  },
  {
    ...
    price: 220,
    image: "veg spring roll.jpeg?height=200&width=200",
    category: "Special Foods",
    distance: 1.9,
  },
  {
    ...
    price: 420,
    image: "/mushroom-risotto.jpg?height=200&width=200",
    category: "Italian",
    distance: 4.2,
  },
  {
    ...
    name: "Caesar Salad",
    price: 280,
    image: "/Caesar-Salad.jpg?height=200&width=200",
    category: "Lunch",
    distance: 2.1,
  },
  {
    ...
    name: "Beef Burger",
    price: 340,
    image: "/beef burger.jpg?height=200&width=200",
    category: "Lunch",
    distance: 1.7,
  },
  {
    ...
    name: "Margarita",
    price: 280,
    image: "/margarita.webp?height=200&width=200",
    category: "Drinks",
    distance: 3.3,
  },
  {
    ...
    name: "Mojito",
    price: 260,
    image: "/mojito.webp?height=200&width=200",
    category: "Drinks",
    distance: 3.6,
  },
]
...
const restaurants = [
  {
    name: "KFC",
    logo: "/kfc.png?height=100&width=100",
    image: "/kfc.webp?height=200&width=200",
    description: "Crispy fried chicken served fast, fresh, and irresistibly delicious.",
  },
  {
    name: "Domino's",
    logo: "/dominos.png?height=100&width=100",
    image: "/dominos.webp?height=200&width=200",
    description: "Satisfy your pizza cravings with fresh, hot, and cheesy flavors.",
  },
  {
    name: "Roadhouse Cafe",
    logo: "/roadhouse cafe.jpg?height=100&width=100",
    image: "/coffee.png?height=200&width=200",
